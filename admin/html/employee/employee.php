<?php 
  ...
  if(isset($_GET['tukhoa'])) {
    ...
    if($page == '' || $page == 1) {
      $begin = 0;
      $sql_lietke_order = "SELECT * FROM employee WHERE employee.`name` LIKE '%".$tukhoa."%' LIMIT 0,3";
    } else {
      $begin = ($page * 3) - 3;
      $sql_lietke_order = "SELECT * FROM employee WHERE employee.`name` LIKE '%".$tukhoa."%' LIMIT $begin,3";
    }
  } else {
    if($page == '' || $page == 1) {
      $begin = 0;
                                ...
                                <div class="pagination d-flex justify-content-center p-3">
                                  <ul class="pagination justify-content-center">
                                    <?php
                                      ...
                                      if(isset($_GET['tukhoa'])) {
                                        $sql_search = "SELECT * FROM employee WHERE employee.`name` LIKE '%".$tukhoa."%'";
