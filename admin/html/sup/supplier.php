<?php 
  ...
  if(isset($_GET['tukhoa'])) {
    ...
    if($page == '' || $page == 1) {
      $begin = 0;
      $sql_lietke_order = "SELECT * FROM supplier WHERE supplier.`name` LIKE '%".$tukhoa."%' LIMIT 0,7";
    } else {
      $begin = ($page * 7) - 7;
      $sql_lietke_order = "SELECT * FROM supplier WHERE supplier.`name` LIKE '%".$tukhoa."%' LIMIT $begin,7";
    }
  } else {
    if($page == '' || $page == 1) {
      $begin = 0;
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              <!-- Search -->
                <form action="/admin/html/sup/supplier.php?tukhoa=tukhoa" method="GET" class="navbar-nav align-items-center">
                                ...
                                <div class="pagination d-flex justify-content-center p-3">
                                  <ul class="pagination justify-content-center">
                                    <?php
                                      ...
                                      if(isset($_GET['tukhoa'])) {
                                        $sql_search = "SELECT * FROM supplier WHERE supplier.`name` LIKE '%".$tukhoa."%'";
